...
const Pricing = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      {/* Hero Section */}
      <div className="flex flex-col gap-y-6 w-full lg:max-w-[1140px] pt-18 pb-12 px-4">
      ...
      <div className="relative flex justify-center items-center w-full mx-auto bg-[#141414] h-64">
          <div className="">Contoh UI (berisi contoh template yang menyesuaikan active button)</div>
      </div>

      {/* Pricing Section */}
      <div className="flex flex-col gap-y-12 w-full lg:max-w-[1140px] py-6 px-4">
        <div className="flex flex-col gap-y-4">
          {/* Service Button */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-center">
          {selected.packages.map((p, index) => (
            <CardPricing
              ...
              desc={p.desc?.[language] || ''}   // pastikan ada desc
              benefit={p.benefit}
              cta={p.cta[language]}
            />
          ))}
