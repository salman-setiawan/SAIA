...
const Pricing = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      {/* Hero Section */}
      <div className="flex flex-col gap-y-6 w-full lg:max-w-[1080px] pt-20 pb-12 px-4">
      ...
      <div className="flex flex-col gap-y-4 sm:gap-y-10 w-full lg:max-w-[1080px] py-6 px-4">
