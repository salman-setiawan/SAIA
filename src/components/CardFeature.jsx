...
const CardFeature = ({label, desc, index}) => {
  const renderIllustration = () => {
    switch(index) {
      case 0: // Landing Page
        return (
          <div className="relative h-46 w-full rounded-md bg-gradient-to-tr from-sky-500/28 via-sky-400/8 to-transparent overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_#0ea5e980,_transparent_60%)] opacity-50"></div>
            <div className="absolute h-46 sm:w-[300px] inset-x-16 sm:inset-x-5 top-5 rounded-lg border border-neutral-700/80 bg-neutral-900/90 shadow-sm">
              ...
              <div className="p-2.5 space-y-1">
                <div className="h-2 w-24 rounded bg-sky-400/70"></div>
                <div className="h-1.5 w-32 rounded bg-neutral-700"></div>
                <div className="mt-2.5 flex gap-1.5">
                  <div className="h-10 flex-1 rounded-md bg-sky-500/70"></div>
      ...
      case 1: // Company Profile Website
        return (
          <div className="relative h-46 w-full rounded-md bg-gradient-to-tr from-emerald-500/28 via-emerald-400/8 to-transparent overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_#22c55e80,_transparent_60%)] opacity-50"></div>
            <div className="absolute h-46 sm:w-[300px] inset-x-16 sm:inset-x-5 top-5 rounded-lg border border-neutral-700/80 bg-neutral-900/90 flex overflow-hidden">
              ...
              <div className="flex-1 p-2.5 space-y-3">
                <div className="space-y-1">
                  <div className="h-2 w-24 rounded bg-emerald-400/80"></div>
      ...
      case 2: // Online Store
        return (
          <div className="relative h-46 w-full rounded-md bg-gradient-to-tr from-violet-500/28 via-violet-400/8 to-transparent overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_#8b5cf680,_transparent_60%)] opacity-50"></div>
            <div className="absolute h-46 sm:w-[300px] inset-x-16 sm:inset-x-5 top-5 rounded-lg border border-neutral-700/80 bg-neutral-900/90 p-2.5 space-y-2">
              ...
              <div className="flex justify-end pt-3 gap-x-2">
                <div className="h-4.5 w-16 rounded-lg bg-violet-500/80"></div>
                <div className="h-4.5 w-16 rounded-lg bg-violet-500/80"></div>
              </div>
            </div>
          </div>
      ...
      case 3: // Custom Web App
        return (
          <div className="relative h-46 w-full rounded-md bg-gradient-to-tr from-cyan-500/28 via-cyan-400/8 to-transparent overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_#06b6d480,_transparent_60%)] opacity-50"></div>
            <div className="absolute h-46 sm:w-[300px] inset-x-16 sm:inset-x-5 top-5 rounded-lg border border-neutral-700/80 bg-neutral-900/90 p-2.5 space-y-2">
      ...
      case 4: // ERP System
        return (
          <div className="relative h-46 w-full rounded-md bg-gradient-to-tr from-amber-500/28 via-amber-400/8 to-transparent overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_#f59e0b80,_transparent_60%)] opacity-50"></div>
