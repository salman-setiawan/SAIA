...
const CardUserflow = ({label, desc, num}) => {
  return (
    <div className="flex flex-col gap-1">
      <div className={`${cardSpecs} flex items-center justify-center h-[40px] w-[40px] text-[20px] font-bold`}>{num}</div>
      <div className={`${cardSpecs} flex flex-col gap-y-1 min-w-[280px]`}>
