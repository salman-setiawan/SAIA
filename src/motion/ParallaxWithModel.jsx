...
const ParallaxWithModel = () => {
  ...
  return (
    <div className="relative w-full h-[320px] md:h-[640px] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none flex justify-center items-center top-80 right-22 sm:right-0">
        <DraggableModel>
      ...
      <div className='absolute bottom-2 right-2 md:bottom-5 md:left-1/2 md:-translate-x-1/2'>
